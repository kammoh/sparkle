...
#ifdef DEBUG
  printf("after LAST rho_whi_aut: ");
  print_state_ref(state, STATE_BRANS);
#endif
  // execute SPARKLE with big number of steps
  sparkle_ref(state, STATE_BRANS, SPARKLE_STEPS_BIG);
#ifdef DEBUG
  printf("after LAST aut sparkle: ");
  print_state_ref(state, STATE_BRANS);
#endif
}
...
#ifdef DEBUG
  printf("after LAST rho_whi_enc: ");
  print_state_ref(state, STATE_BRANS);
#endif
  // execute SPARKLE with big number of steps
  sparkle_ref(state, STATE_BRANS, SPARKLE_STEPS_BIG);
#ifdef DEBUG
  printf("after ProcessPlainText: ");
  print_state_ref(state, STATE_BRANS);
#endif
}
